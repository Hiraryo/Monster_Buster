...
public class Information : MonoBehaviour
{
    ...
    void Update()
    {
        if (Information1_button_f == true)
        {
            ...
            Information_Dialog1.transform.DOScale(endValue: new Vector2(_ZoomX, _ZoomY), duration: 1.0f);
        }
        ...
        if (Information2_button_f == true)
        {
            ...
            Information_Dialog2.transform.DOScale(endValue: new Vector2(_ZoomX, _ZoomY), duration: 1.0f);
        }
        ...
        if (Information3_button_f == true)
        {
            ...
            Information_Dialog3.transform.DOScale(endValue: new Vector2(_ZoomX, _ZoomY), duration: 1.0f);
        }
        ...
        if (Information4_button_f == true)
        {
            ...
            Information_Dialog4.transform.DOScale(endValue: new Vector2(_ZoomX, _ZoomY), duration: 1.0f);
        }
        ...
        if (Information5_button_f == true)
        {
            ...
            Information_Dialog5.transform.DOScale(endValue: new Vector2(_ZoomX, _ZoomY), duration: 1.0f);
        }
        ...
        if (Information6_button_f == true)
        {
            ...
            Information_Dialog6.transform.DOScale(endValue: new Vector2(_ZoomX, _ZoomY), duration: 1.0f);
        }
        ...
        if (Information7_button_f == true)
        {
            ...
            Information_Dialog7.transform.DOScale(endValue: new Vector2(_ZoomX, _ZoomY), duration: 1.0f);
        }
        ...
        if (Information8_button_f == true)
        {
            ...
            Information_Dialog8.transform.DOScale(endValue: new Vector2(_ZoomX, _ZoomY), duration: 1.0f);
        }
