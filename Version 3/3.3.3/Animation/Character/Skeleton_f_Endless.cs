...
public class Skeleton_f_Endless : MonoBehaviour {
    float move_x = -0.2f;
    Collider2D s_Object;
    ...
    int lv;
    int point = 20;
    public static bool combo_skeleton_Endless_add1 = false;
    int stage_lv;
	...
	void Update () {
        combo_skeleton_Endless_add1 = false;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if(collision.tag == "tatumaki")
        {
            ...
            if (player_hit_f == 1 && count < 3)
            {
                Invoke("Skeske", 1);
                sound01.PlayOneShot(sound01.clip);
                combo_skeleton_Endless_add1 = true;
            }
        }
    }
    ...
    public static bool Get_Combo_Endless1()
    {
        return combo_skeleton_Endless_add1;
    }
