...
public class Spawn_skel3_2 : MonoBehaviour {

    public GameObject obj;
    int var;
    int cnt;
    public float interval;
    public static double skeleton_count = 15;
    public bool warning_f2;
    ...
    bool Boss_Endless_f2;

    public bool Endless_f2; //スケルトンが一定数出現すると、ボスを出現させる為に一旦停止フラグ(false : 一定数に達していない, true : 一定数に達した為スケルトン出現を停止)
    int stage_lv;
    ...
    void SpawnObj()
    {
        //if (GameStart_f == true && Boss_Endless_f2 == true)
        if (GameStart_f == true && Endless_f2 == false)
        {
    ...
    void Update()
    {
        ...
        //Boss_Endless_f2 = script2.Boss_Endless_f;
    ...
    public static double Skel3_2_num()
    {
