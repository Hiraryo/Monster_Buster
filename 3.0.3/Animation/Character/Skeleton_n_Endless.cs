...
public class Skeleton_n_Endless : MonoBehaviour {
    float move_x = -0.3f;
    Collider2D s_Object;
    ...
    int point = 10;
    int point_count;
    public static bool combo_skeleton_Endless_add2 = false;
    int stage_lv;
    ...
    void Update()
    {
        combo_skeleton_Endless_add2 = false;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "tatumaki")
        {
            ...
            if (player_hit_f == 1 && count < 2)
            {
                Invoke("Skeske", 1);
                sound01.PlayOneShot(sound01.clip);
                combo_skeleton_Endless_add2 = true;
            }
        }
    }
    ...
    public static bool Get_Combo_Endless2()
    {
        return combo_skeleton_Endless_add2;
    }
